...
import (
	...
	"github.com/somasundar-kapaka/cloudfusion/internal/controller"
...
func init() {
	...
	utilruntime.Must(computealphav1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7e7cbb17.cloudfusion.com",
